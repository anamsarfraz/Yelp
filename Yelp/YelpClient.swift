...
class YelpClient: BDBOAuth1RequestOperationManager {
    ...
    func searchWithTerm(_ term: String, sort: YelpSortMode?, categories: [String]?, deals: Bool?, distance: Double?, offset: Int?, completion: @escaping ([Business]?, Int?, Error?) -> Void) -> AFHTTPRequestOperation {
        ...
        if distance != nil {
            parameters["radius_filter"] =  (distance! * metersPerMile) as AnyObject?
        }
